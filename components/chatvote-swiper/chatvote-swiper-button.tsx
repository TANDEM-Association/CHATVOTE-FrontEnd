...
import { type SwipeType } from "@/lib/chatvote-swiper/chatvote-swiper.types";
import { cn } from "@/lib/utils";

import ChatvoteSwiperSkipButton from "./chatvote-swiper-skip-button";
...
export type ChatvoteSwiperButtonVariant = {
...
const ChatvoteSwiperButton = ({ type, onClick }: Props) => {
  const [clicked, setClicked] = useState(false);

  const variants: Record<SwipeType, ChatvoteSwiperButtonVariant> = {
    yes: {
...
export default ChatvoteSwiperButton;
