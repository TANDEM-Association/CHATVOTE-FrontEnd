...
const ChatvoteSwiperInput = ({
  ...
  return (
    <form
      ...
      className={cn(
        "border-input bg-chat-input relative mx-auto grid min-h-[82px] w-full max-w-xl overflow-hidden rounded-[20px] border shadow-2xl transition-shadow duration-300 ease-out focus-within:border-zinc-300 md:shadow-none dark:focus-within:border-zinc-700",
