    ...
    <section className="prose-sm dark:prose-invert md:prose my-8 max-w-full overflow-x-hidden">
      ...
      <ul>
        <li>
          ...
          personne concernée a donné son consentement au traitement des données
          personnelles la concernant pour une ou plusieurs finalités
          spécifiques.
        </li>
        <li>
          <strong>
            Exécution du contrat et demandes précontractuelles (Art. 6 par. 1 p.
            1 let. b) RGPD)
          </strong>{" "}
          - Le traitement est nécessaire à l&lsquo;exécution d&lsquo;un contrat
          auquel la personne concernée est partie ou à l&lsquo;exécution de
          mesures précontractuelles prises à la demande de celle-ci.
        </li>
        <li>
          <strong>Obligation légale (Art. 6 par. 1 p. 1 let. c) RGPD)</strong> -
          Le traitement est nécessaire au respect d&lsquo;une obligation légale
      ...
      <p>
        ...
        conformément aux exigences légales, en tenant compte de l&lsquo;état de
        la technique, des coûts de mise en œuvre et de la nature, de la portée,
        des circonstances et des finalités du traitement, ainsi que des
        différentes probabilités de survenance et de l&lsquo;étendue de la
        menace pour les droits et libertés des personnes physiques, afin de
        garantir un niveau de protection adapté au risque.
      </p>
      <p>
        Ces mesures comprennent notamment la sécurisation de la confidentialité,
        de l&lsquo;intégrité et de la disponibilité des données par le contrôle
        de l&lsquo;accès physique et électronique aux données, ainsi que de
        l&lsquo;accès, de la saisie, de la transmission, de la sécurisation de
        la disponibilité et de leur séparation.
      </p>
      ...
      <p>
        Nous supprimons les données personnelles que nous traitons conformément
      ...
      <ul>
        ...
        <li>
          ...
          alternativement, de demander une limitation du traitement des données
          conformément aux exigences légales.
        </li>
        <li>
        ...
        <li>
          <strong>
            Droit d&lsquo;introduire une réclamation auprès d&lsquo;une autorité
            de contrôle :
          </strong>{" "}
      ...
      <p>
        Les cookies sont de petits fichiers texte ou d&lsquo;autres éléments de
        mémoire qui stockent des informations sur les terminaux et lisent des
        informations à partir des terminaux. Par exemple, pour enregistrer le
        statut de connexion dans un compte utilisateur, le contenu d&lsquo;un
      ...
      <p>
        ...
        confidentialité afin de l&lsquo;adapter aux exigences légales modifiées
        ou aux changements de nos services. Nous vous recommandons de consulter
